...
if __name__ == '__main__':
    ...
    cust1 = BankAccount(name='Ravi Kumar', mobile_no=9109413180, initial_depo=10000, pin=1234)
    cust2 = BankAccount(name='Ashish', mobile_no=9878765443, initial_depo=20000, pin=4567)
